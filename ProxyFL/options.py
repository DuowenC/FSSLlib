...
def args_parser():
    ...
    # dataset path
    parser.add_argument('--path_cifar10', type=str, default=os.path.join(path_dir, '/data/cdw2/SAGEFL/proxyfl_data/CIFAR10/'))
    parser.add_argument('--path_cifar100', type=str, default=os.path.join(path_dir, '/data/cdw2/SAGEFL/proxyfl_data/CIFAR100/'))
    parser.add_argument('--path_svhn', type=str, default=os.path.join(path_dir, '/data/cdw2/SAGEFL/proxyfl_data/SVHN/'))
    parser.add_argument('--path_cinic10', type=str, default=os.path.join(path_dir, '/data/cdw2/SAGEFL/proxyfl_data/CINIC10/'))
